        ...
        <section class="middile-panel">
          ...
          <div class="text">
            ...
            <form method="post" action="{{ route('article.store') }}" id="regForm" name="regForm" class="form-horizontal"
                    ...
                    @csrf
                <div class="row">
                  <div style="text-align:center; color:#0C0; font-size:15px;">
                  </div>
                              ...
                              <div class="col-sm-6">
                                <div class="form-group">
                                  <label for="inputPassword3" class="col-sm-12 control-label">Country <span
                                      class="msg_required_field">*</span></label>
                                  <div class="col-sm-12" readony="true">
              ...
              <div class="col-md-12 column">
                <div class="list-group ">
                  ...
                  <div class="col-sm-12 manuscript_box ">
                    <div class="form-group">
                      <label for="article_title" style='margin-bottom:5px;' class="col-sm-12 control-label">Article
                        Title<span class="msg_required_field">*</span></label>
                      <div class="col-sm-12">
                        <textarea name="article_title" class="form-control" rows="3" required="required"></textarea>
                      </div>
                    </div>

                    <div class="form-group">
                      <label for="inputEmail3" style='margin-bottom:5px;' class="col-sm-12 control-label">Upload Full
                        Manuscript File<span class="msg_required_field">*</span></label>
                      <div class="col-sm-12">
                        <input type="file" name="file" required="required" id="upload_article" placeholder="">
                      </div>
                    </div>
                    <p>
                  </div>
